 ...
 */
public class ShallowCurvedButton extends JButton {
    
    private static final double ARC_WIDTH  = 5d;
    private static final double ARC_HEIGHT = 5d;
    ...
    public ShallowCurvedButton() {
        super();
    }
    public ShallowCurvedButton(Icon icon) {
        super(icon);
    }
    public ShallowCurvedButton(String text) {
        super(text);
    }
    public ShallowCurvedButton(Action a) {
        super(a);
        //setAction(a);
    }
    public ShallowCurvedButton(String text, Icon icon) {
        super(text, icon);
