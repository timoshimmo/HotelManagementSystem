 ...
 */
public class ServicesHoverListCellRenderer extends DefaultListCellRenderer {
    
    private static final Color HOVER_BACKGROUND_COLOR = new Color(45, 45, 45);
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (isSelected)  {
            ...
            setBorder(BorderFactory.createMatteBorder(0, 4, 0, 0, SELECTED_FOREGROUND_COLOR));
        }
    ...
    public MouseAdapter getHandler(JList list) {
        if (mouseHandler == null) {
            mouseHandler = new HoverMouseHandler(list);
        }
        return mouseHandler;
    }
